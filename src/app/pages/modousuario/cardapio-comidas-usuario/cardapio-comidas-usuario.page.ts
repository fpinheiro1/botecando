...
@Component({
  selector: 'app-cardapio-comidas-usuario',
  templateUrl: './cardapio-comidas-usuario.page.html',
  styleUrls: ['./cardapio-comidas-usuario.page.scss'],
})
export class CardapioComidasUsuarioPage implements OnInit {
  private loading: any;
