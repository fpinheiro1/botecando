...
@Component({
  selector: 'app-cardapio-bebidas-usuario',
  templateUrl: './cardapio-bebidas-usuario.page.html',
  styleUrls: ['./cardapio-bebidas-usuario.page.scss'],
})
export class CardapioBebidasUsuarioPage implements OnInit {
