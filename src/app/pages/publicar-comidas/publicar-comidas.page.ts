...
@Component({
  selector: 'app-publicar-comidas',
  templateUrl: './publicar-comidas.page.html',
  styleUrls: ['./publicar-comidas.page.scss'],
})
export class PublicarComidasPage implements OnInit {
...
ngOnInit() {
  this.publicacao.categoria="Comida";
}
